	...
	<div class="tribe-events-event-meta-wrapper">
		<?php do_action( 'tribe_events_before_the_meta' ); ?>
			<div class="tribe-events-event-meta">
				...
				<a href="<?php tribe_event_link() ?>" title="<?php esc_attr_e('Read More') ?>" class="button button-border accent1 hover-accent1"><span class="btext"><?php wpvge( 'tribe-events-join-text' ) ?></span></a>
