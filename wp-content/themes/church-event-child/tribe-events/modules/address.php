...
<span class="street-address"><?php echo tribe_get_address( $venue_id ); ?></span><span class="delimiter">, </span>
...
if ( tribe_get_city( $venue_id ) ) :
	...
	<?php endif; ?>
	<span class="locality"><?php echo tribe_get_city( $venue_id ); ?></span>
<?php endif; ?>

<?php
// This location's abbreviated region. Full region name in the element title.
if ( tribe_get_region( $venue_id ) ) : ?>
	<span class="delimiter">, </span><abbr class="region tribe-events-abbr" title="<?php esc_attr_e( $full_region ); ?>"><?php echo tribe_get_region( $venue_id ); ?>
<?php endif; ?>

<?php
// This location's postal code.
if ( tribe_get_zip( $venue_id ) ) : ?>
	<span class="delimiter">, </span><span class="postal-code"><?php echo tribe_get_zip( $venue_id ); ?></span>
<?php endif; ?>

<?php
// This location's country.
if ( tribe_get_country( $venue_id ) ) : ?>
	<span class="delimiter">, </span><span class="country-name"><?php echo tribe_get_country( $venue_id ); ?></span>
<?php endif; ?>
